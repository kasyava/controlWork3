                    ...
                    <div className="row h-100 justify-content-center align-items-center">
                        <form id="formRegister" className="col-12">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" id="password" name="displayname" value={this.state.displayname} required onChange={(e)=>this.changeInputHandle(e)}/>
                            </div>
                            <div className="form-group">
                                <label htmlFor="phone">Phone number</label><br/>
                                <input type="text" className="form-control" id="password" name="phone" value={this.state.phone} required onChange={(e)=>this.changeInputHandle(e)}/>
                            </div>
                            <div className="form-group">
                                <button type="submit" id="register" className="btn btn-primary" onClick={(e)=>this.props.sendRegisterForm(e, this.state.username, this.state.password, this.state.displayname, this.state.phone, this.props.history)}>Register</button>
                            </div>
                        </form>
                    </div>
                </div>
